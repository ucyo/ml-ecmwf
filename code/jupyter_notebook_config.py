...
port = int(os.getenv("JUPYTER_PORT", 8080))
ip = os.getenv("JUPYTER_IP", '0.0.0.0')
open_browser = os.getenv("JUPYTER_OPEN_BROWSER", "False").lower() in ("1", "true")
notebook_dir = os.getenv("JUPYTER_NOTEBOOK_DIR", "/home/python/code")
